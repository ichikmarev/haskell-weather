...
listStr :: String
listStr = "Запрос может обрабатываться по любому реальному городу на английском или русском языках.\n" ++
          "В запросе могут использоваться пробелы.\n" ++
          ...
          "Вы получите название города в выбранной стране.\n" ++
...
getWeather :: IO ()
getWeather = do
 putStrLn "Привет! Пожалуйста, введите название своего города >>> \n "
 town <- getLine
 putStrLn ("\nХм, вы ввели город - " ++ town ++ "\nДавайте посмотрим, что там за погода")
 ...
 case d of
  ...
  Right stuff -> putStrLn ("Сейчас температура в вашем городе " ++
